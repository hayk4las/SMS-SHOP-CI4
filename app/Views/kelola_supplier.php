...
<head>
    ...
    <title>Sms Shop || Kelola Supplier</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    <a class="navbar-brand" href="#" style="font-size: 24px; font-weight: bold;">Daftar Supplier</a>
                    ...
                    <div class="container mt-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div class="d-flex align-items-center">
                                <a href="/kelolasupplier/create" class="btn btn-primary btn-sm" style="font-weight: bold;">
                                ...
                                <tbody>
                                    <?php if (!empty($suppliers)): ?>
                                        ...
                                        foreach ($suppliers as $supplier): ?>
                                            <tr>
                                                <td><?= $no++; ?></td>
                                                <td><?= esc($supplier['id_supplier']); ?></td>
                                                <td><?= esc($supplier['nama_supplier']); ?></td>
                                                <td><?= esc($supplier['email']); ?></td>
                                                <td><?= esc($supplier['telepon']); ?></td>
                                                <td><?= esc($supplier['alamat']); ?></td>
                                                <td class="text-center">
                                                    <a href="/kelolasupplier/edit/<?= esc($supplier['id_supplier']); ?>" class="btn btn-sm btn-primary" title="Edit">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <a href="/kelolasupplier/delete/<?= esc($supplier['id_supplier']); ?>" class="btn btn-sm btn-danger" title="Delete" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
